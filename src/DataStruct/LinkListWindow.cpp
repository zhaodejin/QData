...
void LinkListWindow::retranslateUi(QMainWindow *MainWindow) {
...
void LinkListWindow::createLinkListWindow() {
    qDebug()<<"createLinkListWindow"<<endl;
    this->show();
    qDebug()<<"createLinkListWindow"<<endl;

}
void LinkListWindow::insert() {
...
LinkListWindow::LinkListWindow(QWidget *parent):
QWidget(parent),
pAddDataButton(new QPushButton(this)),
textEditDeleteButton(new QLineEdit(this))
{
    this->resize(800, 600);
    ...
    textEditSearchButton = new QLineEdit(this);
    ...
    textSearchReturn = new QLineEdit(this);
